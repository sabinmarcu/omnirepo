...
import { jsBestPracticesRules as baseBestPracticesRules } from './js/bestPractices.js';
import { jsErrorRules as baseErrorsRules } from './js/errors.js';
import { jsES6Rules as baseES6Rules } from './js/es6.js';
import { jsImportRules as baseImportsRules } from './js/import.js';
import { jsStyleRules as baseStyleRules } from './js/style.js';
import { jsVariablesRules as baseVariablesRules } from './js/variables.js';
...
const tsRulesConfig = [
  {
    name: 'TS Overrides Rules',
    rules: tsRules,
  },
] as const satisfies Config[];

export default tsRulesConfig;
