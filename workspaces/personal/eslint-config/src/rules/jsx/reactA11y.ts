...
const logger = getLogger('plugin:react-a11y');
logger.log('Loading A11Y Rules');
...
const reactA11yConfig = await conditionalConfig(
  'react',
  'eslint-plugin-react',
  'eslint-plugin-jsx-a11y',
  () => logger.warn('Skipping A11Y Rules'),
  ({
    'eslint-plugin-jsx-a11y': jsxA11yPlugin,
  }) => [
    jsxConfigCompiler({
      name: 'A11Y Config',
...
export default reactA11yConfig;
