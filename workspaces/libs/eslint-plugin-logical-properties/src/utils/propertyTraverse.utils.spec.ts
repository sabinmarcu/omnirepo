...
import { generateObjectStringFromPath, generateObjectStringsFromPaths, isWildcard, packer, pathToSegments, segmentsIsEmpty, segmentsToPath} from './propertyTraverse.utils.js'
...
describe('propertyTraverse.utils', () => {
  ...
  describe('pathToSegments', () => {
    it('should be a function', () => { expect(pathToSegments).toBeInstanceOf(Function);
    });
    it('should have one argument', () => {
  ...
  describe('segmentsToPath', () => {
    it('should be a function', () => { expect(segmentsToPath).toBeInstanceOf(Function);
    });
    it('should have one argument', () => {
  ...
  describe('isWildcard', () => {
    it('should be a function', () => { expect(isWildcard).toBeInstanceOf(Function);
    });
    it('should have one argument', () => {
  ...
  describe('segmentsIsEmpty', () => {
    it('should be a function', () => { expect(segmentsIsEmpty).toBeInstanceOf(Function);
    });
    it('should have one argument', () => {
  ...
  describe('generateObjectStringFromPath', () => {
    it('should be a function', () => { expect(generateObjectStringFromPath).toBeInstanceOf(Function);
    });
  ...
  describe('generateObjectStringsFromPaths', () => {
    it('should be a function', () => { expect(generateObjectStringsFromPaths).toBeInstanceOf(Function);
    });
    it('should have two arguments', () => {
